...
pub(crate) type SqliteHostStartResult = HostSqliteStartResult;
pub(crate) type SqliteHostStartResultPayload = HostSqliteStartResultPayload;
pub(crate) type SqliteHostStartResultTag = HostSqliteStartResultTag;
...
pub(crate) type SqliteHostNextRowResult = HostSqliteNextRowResult;
pub(crate) type SqliteHostNextRowResultPayload = HostSqliteNextRowResultPayload;
pub(crate) type SqliteHostNextRowResultTag = HostSqliteNextRowResultTag;
pub(crate) type SqliteHostNextRowState = HostSqliteNextRowOk;
pub(crate) type SqliteHostNextRowStatePayload = HostSqliteNextRowOkPayload;
pub(crate) type SqliteHostNextRowStateTag = HostSqliteNextRowOkTag;
pub(crate) type SqliteHostNextRow = HostSqliteNextRowOkRow;
pub(crate) type SqliteHostBeginResult = HostSqliteBeginResult;
pub(crate) type SqliteHostBeginResultPayload = HostSqliteBeginResultPayload;
pub(crate) type SqliteHostBeginResultTag = HostSqliteBeginResultTag;
pub(crate) type SqliteHostTxnFinishResult = HostSqliteTxnFinishResult;
pub(crate) type SqliteHostTxnFinishResultPayload = HostSqliteTxnFinishResultPayload;
pub(crate) type SqliteHostTxnFinishResultTag = HostSqliteTxnFinishResultTag;
