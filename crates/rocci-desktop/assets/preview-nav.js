(function () {
  ...
  spacer.textContent =
    ...
    HEIGHT +
    "; --rocci-chrome-right: 0px; --rocci-chrome-bottom: 0px; height: 100%; overflow: hidden !important; padding: 0 !important; box-sizing: border-box; position: relative; } body { position: absolute !important; inset: var(--rocci-chrome-top) var(--rocci-chrome-right, 0px) var(--rocci-chrome-bottom, 0px) 0 !important; overflow: auto !important; margin: 0 !important; padding: 0; box-sizing: border-box; } body > header, body > [role=\"banner\"] { top: 0 !important; } rocci-preview-nav { display: block; position: fixed; top: 0; left: 0; right: 0; width: 100%; min-width: 100%; height: " +
    HEIGHT +
