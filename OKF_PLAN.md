...
**Status:** active — Phase 0 complete; the contract is approved and Phase 1 is not started
...
| 1 — parser and three-record vertical slice | Not started | No OKF parser, knowledge collection, or seed records have been added |
