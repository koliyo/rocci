...
- The knowledge workflow runs focused tests, Rocci-profile validation, graph inspection, provenance/freshness/source-drift diagnostics, two builds, and a recursive byte comparison in CI.
