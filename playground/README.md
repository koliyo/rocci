...
- **Theme & Styles** (`src/styles.css`): Standalone tokens match `RocdownBase.rocci`. When the workbench is mounted inside a site page, it inherits that page's theme tokens instead of overriding `:root`.
