...
Current shipped-or-not snapshots first. Later bullets are dated measurements
or pointers; they do not replace the two current records. Do not nest this
collection by lifecycle.
