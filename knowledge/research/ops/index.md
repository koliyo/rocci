...
* [Cursor My Machines worker on a personal Mac mini](cursor-my-machines-mac-mini.md) - Personal `agent worker start` so Cloud Agents from the iPhone app execute tool calls on a Mac mini; not Enterprise Self-Hosted Pool. Exploratory.
