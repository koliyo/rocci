...
The [generalized Rocdown block model](generalized-rocdown-block-model.md)
...
- **Do not implement** codegen unless the user asks. Delivery lives in the
  [ungram AST plan](../plans/ungram-ast.md).[^ungram-plan]
...
classified as **base-rocci** in `scripts/check-workspace-deps.py`. It
