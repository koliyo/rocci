...
sources:
  ...
  - id: wasi-http-gaps
    ...
    title: Gaps for running basic-webserver as a WASI HTTP module, including WASI 0.3 async
    author: process:cursor
...
(listen inversion, WASI 0.3 async vs blocking Roc ABI, SSE streams,
sqlite, extra Rust adapter): [basic-webserver
...
[^wasi-http-gaps]: WASI HTTP needs a new adapter host; listen inversion, 0.3 async I/O, SSE streams, sqlite. OS thread pools are a 0.16 process detail, not a WASI requirement.
