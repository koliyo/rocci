...
sources:
  ...
  - id: plan
    resource: ../../plans/rocdown/island-snapshot-roc-reachability.md
...
Implementation plan: [snapshot eval must not compile service-only `@roc`](/plans/rocdown/island-snapshot-roc-reachability.md).
