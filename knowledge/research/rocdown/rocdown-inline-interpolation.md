...
sources:
  ...
  - id: directives-ref
    ...
    last_modified: 2026-08-22
  - id: impl-plan
    resource: ../../plans/rocdown/rocdown-inline-interpolation.md
    title: Rocdown Markdown @{expr} interpolation plan
    author: process:cursor
    last_modified: 2026-08-23
  - id: follow-ons
    resource: ../../plans/rocdown/rocdown-inline-interpolation-follow-ons.md
...
`@{expr}` interpolation](/plans/rocdown/rocdown-inline-interpolation.md). This
...
blocks. Implementation: [Rocdown Markdown `@{expr}` interpolation](/plans/rocdown/rocdown-inline-interpolation.md).
v1 gap-closing: [Rocdown `@{expr}` follow-ons after v1](/plans/rocdown/rocdown-inline-interpolation-follow-ons.md).
