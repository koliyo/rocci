...
sources:
  ...
  - id: rocdown-pages
    ...
    last_modified: 2026-08-22
  - id: docs-plan
    resource: ../plans/comprehensive-rocci-documentation.md
  ...
  - id: first-use
    ...
    last_modified: 2026-08-22
  - id: follow-on-plan
    resource: ../plans/rocci-dev-docs-stack-ia.md
...
Implementation: [stack-first docs plan](../plans/rocci-dev-docs-stack-ia.md).[^follow-on-plan]
