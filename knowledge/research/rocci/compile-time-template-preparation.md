...
sources:
  ...
  - id: string-theme-plan
    ...
    title: Phase 0 named Str owners; painter remeasure not started
  - id: experiment
...
HTTP origin and Linux remain unmeasured. Theme `Str` owners are named; painter remeasure is not started.
