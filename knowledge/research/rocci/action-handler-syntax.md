...
sources:
  ...
  - id: datastar-signals
    ...
    author: organization:star-federation
  - id: original-plan
    resource: ../../plans/rocci/action-handler-syntax.md
...
[handler UI boundary plan](/plans/rocci/handler-ui-boundary.md).[^follow-up-plan]
...
[implementation sequence](/plans/rocci/verb-first-handler-declarations.md). The UI
