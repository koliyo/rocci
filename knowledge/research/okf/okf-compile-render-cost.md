...
`rocci-okf run knowledge/plans/okf/okf-load-performance.md` (parse cache cold):
...
The [load-performance plan](/plans/okf/okf-load-performance.md) correctly left Roc
...
The [generation-pipeline research](/research/rocci/rocci-components-in-generation.md) predicted
