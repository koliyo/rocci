...
record](/research/okf/okf-compile-render-cost.md) are machine-local, not a
...
**Exit:** `run` preview of `knowledge/research/okf/okf-compile-render-cost.md`
...
| Measurement evidence | `knowledge/research/okf/okf-compile-render-cost.md` |
