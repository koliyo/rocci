...
`main` (Phases 0–1); Linux and theme `Str` remain unmeasured; macOS HTTP
origin matches with no visible renderer gain.
...
Phases 0–1 completed locally on `main`; [theme/string Html escaping](./html-string-theme-escape.md) is
