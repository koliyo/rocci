...
opened with `rocdown run knowledge/plans/shared/cli-entry-points.md` therefore renders
...
rocci-okf run knowledge/plans/shared/cli-entry-points.md
```
...
Exit when `rocci-okf run knowledge/plans/shared/cli-entry-points.md` opens the
...
Exit when `rocdown run knowledge/plans/shared/cli-entry-points.md` and
`rocci run knowledge/plans/shared/cli-entry-points.md` both name `rocci-okf run`.
