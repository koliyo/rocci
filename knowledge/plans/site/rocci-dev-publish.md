...
sources:
  ...
  - id: research
    resource: ../../research/site/rocci-dev-publish.md
...
This plan turns the [publishing research](/research/site/rocci-dev-publish.md)
...
Artifact packaging stays in [efficient publishing](/plans/rocdown/efficient-publishing.md).
Git forge migration stays in [Tangled hosting](/plans/ops/tangled-hosting.md). This plan
