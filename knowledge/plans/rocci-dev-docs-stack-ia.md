...
This plan executes the [stack-first IA research](../research/rocci-dev-docs-stack-ia.md).
...
documentation plan](comprehensive-rocci-documentation.md). It keeps that
...
| --- | --- |
| [Comprehensive Rocci documentation](comprehensive-rocci-documentation.md) | Historical for Phases 0–6 content fill. IA, Rocci-only scope, academy chrome, and the URL-alias rule are superseded. Other quality rules remain. Phase 7 first-use sessions are not a gate for this rewrite. |
...
| [rocci-app-docs](rocci-app-docs.md) | `/examples/` ownership unchanged. |
