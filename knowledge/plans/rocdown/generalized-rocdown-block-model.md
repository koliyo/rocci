...
research](/research/rocdown/generalized-rocdown-block-model.md). Phases 1–7 below
...
The [chrome-library plan](/plans/rocci/rocci-component-generation.md) owns outline,
...
- Generate AST types (and later syntax kinds) from the ungram; CI fails on
  drift. Owned by the [ungram AST plan](/plans/rocci/ungram-ast.md), which also covers
