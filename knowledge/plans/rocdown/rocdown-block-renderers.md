...
description: "Phased delivery of a schema/renderer split for :kind blocks. Phases 1–7 are in the crate; Phase 2 still flattens typed child records to Html before parent painters. Phase 8 @block and Phase 9 heading Prose are leftover. Post-landing comparison: ../research/rocdown/rocdown-block-renderers-comparison.md."
...
sources:
  - id: research
    resource: ../../research/rocdown/rocdown-block-renderers.md
    title: Custom Rocdown block schemas and renderers research
    author: process:cursor
    last_modified: 2026-08-19
  - id: comparison
    resource: ../../research/rocdown/rocdown-block-renderers-comparison.md
...
research](/research/rocdown/rocdown-block-renderers.md). Architecture records and
...
comparison:
[landed renderers vs related systems](/research/rocdown/rocdown-block-renderers-comparison.md).[^research][^comparison][^rocdown-readme]
...
- Infer schema from `@component` headers via `parse_component_params`
  ...
  [research examples](/research/rocdown/rocdown-block-renderers.md#worked-examples).
