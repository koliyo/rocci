...
sources:
  ...
  - id: launch-audit
    resource: ../audits/rocci-dev-public-launch.md
...
The [app-docs plan](rocci-app-docs.md) already staged `/examples/<id>/` and
...
4. `crates/rocci-docs/README.md`, `docker/README.md`,
   ...
   [app-docs plan](rocci-app-docs.md) live-origins note, and
   [public-launch audit](../audits/rocci-dev-public-launch.md) record that
