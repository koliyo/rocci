...
sources:
  - id: audit
    resource: ../audits/public-ci-security.md
...
Findings F1–F7 in the [security review](../audits/public-ci-security.md)
...
preview](public-preview-community.md) launch gate and the
[public-launch checklist](../audits/rocci-dev-public-launch.md) are also
