...
* [Hybrid Rocdown islands for CDN-static sites](hybrid-rocdown-islands.md) - Phases 1–6 exist on a branch; rebase onto main's `:name[params]` widget forest is required (phases 7–10). Exploratory; not shipped.
