...
* [Hybrid Rocdown islands for CDN-static sites](hybrid-rocdown-islands.md) - Phase 7 rebased the hybrid branch onto main's `:name[params]` / `BlockCall` AST; phases 8–10 remain. Exploratory; not shipped.
