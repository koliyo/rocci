...
* [rocci.dev public-launch checklist](rocci-dev-public-launch.md) - After the 2026-08-23 Should pass: support matrix and GitHub-issues feedback URL are published; reserved example hostnames are not advertised as live. Remaining gates are a signed-out staging smoke, a tagged clean install, the known repository-visibility flip, and production DNS.
