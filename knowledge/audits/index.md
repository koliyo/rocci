...
* [rocci.dev public-launch checklist](rocci-dev-public-launch.md) - After the 2026-08-23 surface sweep: community-health files, Contributing rewrite, linguist-vendored grammars, and archived root leftovers are in tree; remaining gates are a signed-out staging smoke and the known repository-visibility flip.
