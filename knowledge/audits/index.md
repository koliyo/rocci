...
* [rocci.dev public-launch checklist](rocci-dev-public-launch.md) - Current site is close to an experimental preview; GitHub is still private, News 308s hit retired academy URLs, an unpublished first-use page is in sitemap and the finder, and community-health files are missing.
