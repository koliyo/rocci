...
* [rocci.dev public-launch checklist](rocci-dev-public-launch.md) - After the 2026-08-22 PR landings: no News 308s, first-use page deleted, first-contact copy is verb-first; remaining gates are community-health files, a thin Contributing page, and a signed-out staging smoke. Repository privacy until flip is known.
