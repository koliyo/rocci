...
description: Profiled `rocci-okf run knowledge/plans/rocdown/hybrid-rocdown-islands.md`; after load-performance Phases 1–4, release first-open `load` is 290ms and watch rebuilds reuse unchanged parses.
...
This audit measures why `rocci-okf run knowledge/plans/rocdown/hybrid-rocdown-islands.md`
...
```text
cargo run -q -p rocci-okf -- run knowledge/plans/rocdown/hybrid-rocdown-islands.md \
...
[OKF load-performance improvements](/plans/okf/okf-load-performance.md). These
