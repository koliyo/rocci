...
* [Hosted Roc-gated crate tests exceed ten minutes](roc-gated-ci-duration.md) - 16-minute hosted `roc` job: island tests wait 120–180s after Roc rejects an absolute in-tree platform pin; cold compile and musl `libhost` add several minutes. Descriptive.
