...
Report incidents to **oss@rocci.dev**. All complaints will be reviewed and
...
1. **Correction.** A private, written warning and clarity about the nature of
   the violation.
2. **Warning.** A warning with consequences for continued behavior, including a
   period with no interaction with the people involved.
